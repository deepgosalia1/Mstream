...
const LOADING_TYPE = ['progress', 'activity'];
...
export default class Spinner extends React.Component {
  ...
  static propTypes = {
    ...
    loadingType: PropTypes.oneOf(LOADING_TYPE),
  ...
  _renderDefaultContent() {
    ...
    return (
      <View style={styles.background}>
        {
          this.props.loadingType == 'activity' && <ActivityIndicator
        ...
        {
          this.props.loadingType == 'progress' &&
