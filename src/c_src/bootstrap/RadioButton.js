...
export default class RadioForm extends React.Component {
  ...
  static defaultProps = {
    ...
    selectedButtonColor: colorUtils.BUTTON_COLOR,
...
export class RadioButtonInput extends React.Component {
  constructor (props) {
    ...
    this.state = {
      isSelected: false,
      buttonColor: props.buttonColor || colorUtils.BUTTON_COLOR
    }
  }
  render () {
...
RadioButtonInput.defaultProps = {
  buttonInnerColor: colorUtils.BUTTON_COLOR,
  buttonOuterColor: colorUtils.BUTTON_COLOR,
  disabled: false
}
