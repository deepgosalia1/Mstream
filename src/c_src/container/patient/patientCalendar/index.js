...
export default class PatientCalendar extends Component {
  ...
  _renderItem = (item,index) => {
    ...
    return (
      <View style={{ flex: 1, padding: 5,borderBottomWidth: (calendarData.index%3==0) ? 1 : 0  }}>
        <TouchableOpacity
        ...
        >
          ...
          <View style={{ flex: 0.8, flexDirection: 'column', paddingTop: 10, paddingBottom: 10, height: '100%', marginLeft: 5 }}>
            <View style={{ flexDirection: 'row' }}>
              ...
              <Text style={{ fontFamily: fontUtils.FONT_FAMILY, fontSize: 16, color: '#000', alignSelf: 'center' }}>{calendarData.title}</Text>
            </View>
            <Text style={{ fontFamily: fontUtils.FONT_FAMILY, fontSize: 14, color: 'grey', marginLeft: 9 }}>{calendarData.description}</Text>
          </View>
          <Image
        ...
        >
          <View style={{ flex: 0.2, paddingTop: 10, paddingBottom: 10, alignItems: 'center', justifyContent: 'center', marginRight: 5, flexDirection: 'column' }}>
            <View>
              ...
              <Text style={{ color: 'grey' }}>12:00 AM</Text>
            </View>
