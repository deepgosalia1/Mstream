...
var flatListData = require('./medicalillness.list.json')
export default class MyHealthSummaryCommon extends Component {
        ...
        return (
            <View style={Style.containerStyle}>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => { this.props.navigation.navigate('addmedicalIllness') }}>
                    <Image
