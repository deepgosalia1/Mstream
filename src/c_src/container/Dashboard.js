          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <View style={styles.laneView}>
                ...
                <TouchableOpacity
                  onPress={() => this.props.navigation.navigate('acknowledgeAlert',{loggedInUser:this.state.loggedInUser})}
                >
                  <View style={{ flexDirection: 'column' }}>
                    ...
                    <View style={{ flexDirection: 'row', width: 350, justifyContent: 'space-between' }}>
                      <Text style={{ marginTop: 2, color: "#616161", fontSize: 15, fontFamily: fontUtils.FONT_FAMILY, fontStyle: 'normal' }}>{item.specialization}</Text>
