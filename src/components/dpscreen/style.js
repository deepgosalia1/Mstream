...
var styles = StyleSheet.create({
    ...
    blur_imageview: { width: '100%', height: '42%', backgroundColor: '#333', flexDirection: 'column', marginTop: 45 },
    ...
    editshare: {alignSelf: 'center', width: 100, flexDirection: 'row', height: 70, alignItems:'center', justifyContent:'center' },
});
